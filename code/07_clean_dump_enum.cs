...
internal enum SOCKSVersions
{
	Unknown = 0,
	V5 = 5,
}

internal enum SOCKSMethods
{
...
private enum PemUtilities.PemBaseAlg
{
	AES_128 = 0,
	AES_192 = 1,
	AES_256 = 2,
...
private enum PemUtilities.PemMode
{
	CBC = 0,
	CFB = 1,
	ECB = 2,
...
private enum CipherUtilities.CipherAlgorithm
{
	AES = 0,
	ARC4 = 1,
	BLOWFISH = 2,
...
private enum CipherUtilities.CipherMode
{
	ECB = 0,
	NONE = 1,
	CBC = 2,
...
private enum CipherUtilities.CipherPadding
{
	NOPADDING = 0,
	RAW = 1,
	ISO10126PADDING = 2,
...
private enum DigestUtilities.DigestAlgorithm
{
	BLAKE2B_160 = 0,
	BLAKE2B_256 = 1,
	BLAKE2B_384 = 2,
...
private enum WrapperUtilities.WrapAlgorithm
{
	AESWRAP = 0,
	CAMELLIAWRAP = 1,
	DESEDEWRAP = 2,
...
public enum Ed448.Algorithm
{
	Ed448 = 0,
	Ed448ph = 1,
}

private enum ChaCha20Poly1305.State
{
	Uninitialized = 0,
	EncInit = 1,
	EncAad = 2,
...
private enum EaxBlockCipher.Tag
{
	N = 0,
	H = 1,
	C = 2,
...
public enum Target.Choice
{
	Name = 0,
	Group = 1,
}

public enum DeclarationOfMajority.Choice
{
	NotYoungerThan = 0,
	FullAgeAtCountry = 1,
	DateOfBirth = 2,
...
public enum RequestedCertificate.Choice
{
...
private enum TcpClient.Properties
{
	LingerState = 1,
	NoDelay = 2,
	ReceiveBufferSize = 4,
...
private enum LoggingContext.LoggingContextFieldType
{
	Long = 0,
	Bool = 1,
	String = 2,
...
private enum InflateBlocks.InflateBlockMode
{
	TYPE = 0,
	LENS = 1,
	STORED = 2,
...
private enum InflateManager.InflateManagerMode
{
	METHOD = 0,
	FLAG = 1,
	DICT4 = 2,
...
public enum HostProtocolSupport
{
	Unknown = 0,
	HTTP1 = 1,
	HTTP2 = 2,
...
private enum ServantStatusListViewItemDrawRandomLimitCountSetting.MaskType
{
	NONE = 0,
	NOT_COMBINE = 1,
	ENABLE_OWN_ALL_OPTION = 2,
	ENABLE_SUPPORT_ALL_OPTION = 3,
	ENABLE_ALL_OPTION = 4,
}
...
public enum DataNameKind.Kind
{
	...
	QUEST_RELEASE = 68,
	QUEST_PHASE = 69,
	QUEST_PHASE_DETAIL = 70,
	QUEST_GROUP = 71,
	QUEST_RANDOM_GROUP = 72,
	QUEST_CONSUME_ITEM = 73,
	QUEST_MESSAGE = 74,
	VIEW_QUEST_INFO = 75,
	VIEW_ENEMY = 76,
	VIEW_QUEST_ENEMY_INFO = 77,
	AREA = 78,
	BGM = 79,
	EVENT_QUEST = 80,
	EVENT_CAMPAIGN = 81,
	...
	SERVANT_EXP = 85,
	COMBINE_SKILL = 86,
	COMBINE_TREASUREDEVICE = 87,
	ILLUSTRATOR = 88,
	CV = 89,
	TREASUREDEVICE_LEVEL = 90,
	TREASUREDEVICE_DETAIL = 91,
	USER_FOLLOWER = 92,
	NPC_FOLLOWER = 93,
	NPC_SERVANT_FOLLOWER = 94,
	USER_EVENT = 95,
	USER_PROFILE = 96,
	USER_SHOP = 97,
	USER_CONTINUE = 98,
	...
	COMBINE_LIMIT = 110,
	CARD = 111,
	COMBINE_QP_SVT_EQUIP = 112,
	SERVANT_LIMIT_ADD = 113,
	SERVANT_RARITY = 114,
	SET_ITEM = 115,
	RECOVER = 116,
	BANNER = 117,
	...
	BOX_GACHA_TALK = 124,
	USER_BOX_GACHA = 125,
	BOX_GACHA_HISTORY = 126,
	BATTLE_BG = 127,
	TIPS_BATTLE = 128,
	USER_LOGIN = 129,
	VOICE = 130,
	EVENT_REWARD_EXTRA = 131,
	EVENT_MISSION = 132,
	EVENT_MISSION_CONDITION = 133,
	EVENT_MISSION_COND_DETAIL = 134,
	EVENT_MISSION_ACTION = 135,
	EVENT_MISSION_ACTION_ADD = 136,
	EVENT_MISSION_ADD = 137,
	EVENT_REWARD_SET = 138,
	COMPLETE_MISSION = 139,
	USER_EVENT_MISSION = 140,
	USER_EVENT_MISSION_COND_DETAIL = 141,
	BOX_GACHA_BASE_DETAIL = 142,
	CLOSED_MESSAGE = 143,
	USER_SERVANT_LEADER = 144,
	FUNCTION_GROUP = 145,
	EVENT_RAID = 146,
	TOTAL_EVENT_RAID = 147,
	USER_EVENT_RAID = 148,
	EVENT_POINT = 149,
	EVENT_POINT_GROUP = 150,
	TOTAL_EVENT_POINT = 151,
	USER_EVENT_POINT = 152,
	USER_PRESENT_HISTORY = 153,
	MASTER_MISSION = 154,
	SERVANT_EXCEED = 155,
	PARTIAL_MAINTENANCE = 156,
	GUIDE = 157,
	MASTER_MISSION_DISPLAY_INFO = 158,
	GACHA_GROUP = 159,
	QUEST_RESET = 160,
	WAR_ADD = 161,
	EVENT_ITEM_DISPLAY = 162,
	EVENT_ITEM_DISPLAY_GROUP = 163,
	EVENT_ITEM_DISPLAY_RELEASE = 164,
	EVENT_TUTORIAL = 165,
	EVENT_TUTORIAL_COND = 166,
	VOICE_RELEASE = 167,
	EVENT_SUPER_BOSS = 168,
	USER_SUPER_BOSS = 169,
	QUEST_SCRIPT = 170,
	QUEST_SCRIPT_RELEASE = 171,
	MATERIAL_FOLDER = 172,
	RESTRICTION = 173,
	QUEST_RESTRICTION = 174,
	SERVANT_VOICE_RELATION = 175,
	SHOP_DETAIL = 176,
	SERVANT_SCRIPT_ADD = 177,
	COMBINE = 178,
	AI_FIELD = 179,
	SERVANT_COMMENT_ADD = 180,
	EVENT_FILTER = 181,
	USER_SUPPORT_DECK = 182,
	EVENT_REWARD_SCENE = 183,
	EVENT_VOICE_PLAY = 184,
	GACHA_SUB = 185,
	GACHA_DETAIL = 186,
	GACHA_BONUS_SELECT = 187,
	GACHA_BONUS_SELECT_LINEUP = 188,
	SERVANT_CHANGE = 189,
	VOICE_COND = 190,
	BGM_RELEASE = 191,
	MYROOM_ADD = 192,
	SHOP_ACTION = 193,
	EVENT_REWARD_SCENE_RELEASE = 194,
	MAP = 195,
	MAP_COND = 196,
	MAP_BUTTON = 197,
	BANNER_ADD = 198,
	...
	COMBINE_COSTUME = 203,
	SERVANT_COSTUME = 204,
	SERVANT_COSTUME_RELEASE = 205,
	USER_FRIEND_REQUEST_HISTORY = 206,
	USER_BLACKLIST = 207,
	ITEM_SELECT = 208,
	EVENT_RACE = 209,
	EVENT_RACE_RESULT = 210,
	QUEST_RACE_POINT = 211,
	USER_EVENT_RACE = 212,
	EVENT_SCRIPT = 213,
	EVENT_SCRIPT_RELEASE = 214,
	SPOT_PATH = 215,
	SPOT_ADD = 216,
	TOTAL_EVENT_RACE = 217,
	EVENT_POINT_GROUP_ADD = 218,
	VOICE_PLAY_GROUP = 219,
	VOICE_PLAY_COND = 220,
	GACHA_STORY_ADJUST = 221,
	SERVANT_FLAG = 222,
	SERVANT_FLAG_RELEASE = 223,
	EVENT_LOCATION_CAMPAIGN = 224,
	CAMPAIGN_INFO = 225,
	DIALOG_MESSAGE = 226,
	SERVANT_INDIVIDUALITY = 227,
	BOARD_MESSAGE = 228,
	BOARD_MESSAGE_RELEASE = 229,
	EVENT_SERVANT_FATIGUE = 230,
	USER_EVENT_DECK = 231,
	EVENT_TOWER = 232,
	EVENT_TOWER_REWARD = 233,
	EVENT_BULLETIN_BOARD = 234,
	EVENT_BULLETIN_BOARD_RELEASE = 235,
	EVENT_FACTORY = 236,
	SHOP_GROUP = 237,
	AURA_EFFECT = 238,
	AURA_EFFECT_POS_OVERWRITE = 239,
	USER_EVENT_MISSION_FIX = 240,
	NOT_END_EVENT_MISSION_FIX = 241,
	ENEMY_MASTER = 242,
	ENEMY_MASTER_BATTLE = 243,
	SERVANT_SKILL_RELEASE = 244,
	SERVANT_PASSIVE_SKILL_RELEASE = 245,
	SERVANT_TREASUREDEVICE_RELEASE = 246,
	MAP_GIMMICK_RELEASE = 247,
	COMMAND_CODE = 248,
	SERVANT_COMMAND_CODE_UNLOCK = 249,
	USER_COMMAND_CODE = 250,
	USER_COMMAND_CODE_COLLECTION = 251,
	USER_SERVANT_COMMAND_CODE = 252,
	COMMAND_CODE_SKILL = 253,
	COMMAND_CODE_SKILL_RELEASE = 254,
	COMMAND_CODE_COMMENT = 255,
	EVENT_STATUS = 256,
	EVENT_STATUS_QUEST = 257,
	COMMON_RESTRICTION = 258,
	EVENT_POINT_BUFF = 259,
	USER_FOLLOW = 260,
	EVENT_REWARD_GUIDE_RELEASE = 261,
	NPC_SERVANT_EQUIP = 262,
	EVENT_CAMPAIGN_RELEASE = 263,
	SERVANT_MATERIAL_FOLDER = 264,
	EVENT_EQUIP_SKILL_RELEASE = 265,
	EVENT_POINT_ACTIVITY = 266,
	FUNCTION_CATEGORY = 267,
	QUEST_PICKUP = 268,
	EVENT_UI = 269,
	EVENT_UI_RELEASE = 270,
	EVENT_UI_VALUE = 271,
	EVENT_CONQUEST_REWARD = 272,
	NPC_FOLLOWER_RELEASE = 273,
	EVENT_BONUS_FILTER = 274,
	EVENT_BONUS_FILTER_GROUP_INFO = 275,
	EVENT_BONUS_FILTER_GROUP_MEMBER = 276,
	USER_GACHA_EXTRA_COUNT = 277,
	COMMAND_CARD_RANK_PARAM = 278,
	USER_SERVANT_COMMAND_CARD = 279,
	PRIVILEGE = 280,
	USER_PRIVILEGE = 281,
	QUEST_DATE_RANGE = 282,
	EVENT_POINT_UPPER = 283,
	EVENT_POINT_UPPER_RELEASE = 284,
	USER_QUEST_ROUTE = 285,
	EVENT_BOSS_STATUS_UI = 286,
	COMMON_RELEASE = 287,
	QUEST_SPOT_RELEASE = 288,
	VOICE_MATERIAL_COND = 289,
	CLASS_RELATION_OVERWRITE = 290,
	EVENT_GROUP = 291,
	ASSETBUNDLE_KEY = 292,
	TOTAL_BOX_GACHA = 293,
	SERVANT_TREASURE_DEVICE_DAMAGE = 294,
	USER_EVENT_SERVANT_FATIGUE = 295,
	EVENT_REWARD_BG = 296,
	EVENT_FATIGUE_RECOVERY = 297,
	EVENT_BOOST_ITEM_USED = 298,
	STATUS_EFFECT_POS_OVERWRITE = 299,
	QUEST_PHASE_DETAIL_ADD = 300,
	VOICE_CLOSED_MESSAGE = 301,
	STAGE_REMAP = 302,
	USER_COMBINE_EXP = 303,
	EVENT_BOARD_GAME_CELL = 304,
	EVENT_BOARD_GAME_TOKEN = 305,
	EVENT_BOARD_GAME_TOKEN_REWARD = 306,
	USER_EVENT_BOARD_GAME_TOKEN = 307,
	SERVANT_ANIMATION_OVERWRITE = 308,
	OPENING_MOVIE = 309,
	SERVANT_LIMIT_SPOILER_PROTECTION = 310,
	PICKUP_USER_FOLLOWER = 311,
	SERVANT_COLLECTION = 312,
	GACHA_BEHAVIOR = 313,
	EVENT_QUEST_COOLTIME = 314,
	USER_EVENT_QUEST_COOLTIME = 315,
	BOOST = 316,
	WARBOARD = 317,
	WARBOARD_SQUARE = 318,
	WARBOARD_ROAD = 319,
	WARBOARD_STAGE = 320,
	WARBOARD_ACTION_POINT = 321,
	WARBOARD_ACTION_TREND = 322,
	WARBOARD_TACTICAL_TREND = 323,
	WARBOARD_STAGE_LAYOUT = 324,
	WARBOARD_STAGE_NPC = 325,
	WARBOARD_AI = 326,
	WARBOARD_RATING_BASE = 327,
	WARBOARD_RATING_OFFSET = 328,
	WARBOARD_ITEM = 329,
	WARBOARD_TREASURE = 330,
	WARBOARD_QUEST = 331,
	WARBOARD_DATA = 332,
	WARBOARD_INDIVIDUALITY_CLASS = 333,
	WARBOARD_ACTION_TREND_COND = 334,
	WARBOARD_ACTION_POINT_CLASS = 335,
	EVENT_PANEL_MAP = 336,
	EVENT_PANEL_MAP_DETAIL = 337,
	EVENT_PANEL_SPOT = 338,
	EVENT_PANEL_SCAN = 339,
	EVENT_DIGGING = 340,
	EVENT_DIGGING_REWARD = 341,
	EVENT_DIGGING_BLOCK = 342,
	USER_EVENT_DIGGING = 343,
	COMMON_CONSUME = 344,
	USER_EVENT_MAP = 345,
	USER_EVENT_SPOT = 346,
	WAR_GROUP = 347,
	SERVANT_LIMIT_IMAGE = 348,
	FRIENDSHIP_QUEST_DIALOG_INFO = 349,
	QUEST_RESTRICTION_INFO = 350,
	ASSIST = 351,
	WARBOARD_EFFECT = 352,
	WARBOARD_ONBOARD_SKILL = 353,
	BEFORE_BIRTH_DAY = 354,
	LOGIN_QUEST = 355,
	EVENT_COMBINE_COSTUME = 356,
	WARBOARD_STAGE_PIECE_DETAIL = 357,
	SERVANT_TREASURE_DEVICE_ADD = 358,
	SKILL_ADD = 359,
	SERVANT_LEVEL_DETAIL = 360,
	GACHA_APPEND = 361,
	USER_GACHA_DRAW_LOG = 362,
	SERVANT_APPEND_PASSIVE_SKILL = 363,
	USER_SERVANT_APPEND_PASSIVE_SKILL = 364,
	USER_SERVANT_APPEND_PASSIVE_SKILL_LV = 365,
	SVT_APPEND_PASSIVE_SKILL_UNLOCK = 366,
	COMBINE_APPEND_PASSIVE_SKILL = 367,
	SVT_COIN = 368,
	USER_SVT_COIN = 369,
	SERVANT_ADD = 370,
	TREASURE_BOX = 371,
	TREASURE_BOX_GIFT = 372,
	TREASURE_BOX_TALK = 373,
	USER_EVENT_EXPEDITION = 374,
	EVENT_EXPEDITION = 375,
	EVENT_EXPEDITION_PIECE = 376,
	EVENT_RECIPE = 377,
	EVENT_RECIPE_GIFT = 378,
	USER_EVENT_FORTIFICATION = 379,
	EVENT_FORTIFICATION = 380,
	EVENT_FORTIFICATION_DETAIL = 381,
	EVENT_FORTIFICATION_SVT = 382,
	USER_SERVANT_VOICE_PLAYED = 383,
	UPDATE_PROFILE_DIALOG_INFO = 384,
	SVT_MATERIAL_TD = 385,
	BATTLE_MASTER_IMAGE = 386,
	USER_FRIEND_POINT_GACHA_FREE_DRAW_CAMPAIGN_LOG = 387,
	USER_EVENT_RANDOM_MISSION = 388,
	EVENT_PROGRESS_VALUE = 389,
	SVT_MULTI_PORTRAIT = 390,
	EVENT_RANDOM_MISSION = 391,
	USER_GACHA_HISTORY = 392,
	USER_COIN_ROOM = 393,
	EVENT_BUDDY_POINT = 394,
	EVENT_SERVANT_POINT_RANK = 395,
	USER_EVENT_SERVANT_POINT = 396,
	FIELD_MOTION = 397,
	USER_DELETE_RESERVATION = 398,
	SERVANT_SCRIPT_MULTIPLE = 399,
	EQUIP_ADD = 400,
	QUEST_RELEASE_OVERWRITE = 401,
	USER_EVENT_ALLOUT_BATTLE = 402,
	QUEST_SCRIPT_MATERIAL_NEXT = 403,
	BATTLE_MESSAGE = 404,
	BATTLE_MESSAGE_GROUP = 405,
	USER_NPC_SVT_RECORD = 406,
	BUFF_TYPE_DETAIL = 407,
	WARBOARD_MESSAGE = 408,
	WARBOARD_PARTY_SKILL = 409,
	WARBOARD_MESSAGE_SCRIPT = 410,
	WAR_QUEST_SELECTION = 411,
	WARBOARD_STAGE_DETAIL = 412,
	QUEST_SCRIPT_MATERIAL_OVERWRITE = 413,
	QUEST_SCRIPT_BRANCH_MATERIAL = 414,
	AD_CHECK_POINT = 415,
	GIFT_DETAIL = 416,
	COMBINE_LIMIT_GIFT = 417,
	EVENT_COOLTIME_REWARD = 418,
	USER_EVENT_COOLTIME_REWARD = 419,
	CLASS_BOARD_CLASS = 420,
	CLASS_BOARD_BASE = 421,
	CLASS_BOARD_LINE = 422,
	CLASS_BOARD_LOCK = 423,
	CLASS_BOARD_SQUARE = 424,
	CLASS_BOARD_COMMAND_SPELL = 425,
	USER_CLASS_BOARD_SQUARE = 426,
	SERVANT_CARD_ADD = 427,
	MAP_LAYER = 428,
	SPOT_LAYER = 429,
	MAP_GIMMICK_LAYER = 430,
	EVENT_DATA_LOST_BATTLE = 431,
	EVENT_DATA_LOST_BATTLE_RESET = 432,
	USER_EVENT_DATA_LOST = 433,
	QUEST_HINT = 434,
	FUNC_TYPE_DETAIL = 435,
	BUFF_CONVERT = 436,
	SKILL_GROUP = 437,
	SKILL_GROUP_OVERWRITE = 438,
	SKILL_INDIVIDUALITY = 439,
	RESTRICTION_BASE = 440,
	RESTRICTION_SLOT = 441,
	RESTRICTION_SLOT_DETAIL = 442,
	RESTRICTION_MESSAGE = 443,
	RESTRICTION_WHOLE = 444,
	FUNC_DISP = 445,
	EVENT_COMMAND_ASSIST = 446,
	EVENT_MISSION_GROUP = 447,
	COMBINE_LIMIT_RELEASE = 448,
	TREASURE_DEVICE_SEQUENCE_WEIGHT = 449,
	HEEL_PORTRAIT = 450,
...
public enum ResponseCommandKind.Kind
{
	...
	BATTLE_RESUME = 37,
	CARD_LIMIT = 38,
	SERVANT_EQUIP_SET = 39,
	SERVANT_EQUIP_COMBINE = 40,
	DEBUG_QUEST = 41,
	SET_BIRTHDAY = 42,
	ITEM_USE = 43,
	ITEM_RECOVER = 44,
	...
	BOX_GACHA_RESET = 47,
	MISSION_NOTIFY = 48,
	EV_MISSION_REWARD = 49,
	SUPPORT_SERVANT = 50,
	BATTLE_SCENARIO = 51,
	DECK_EDIT_NAME = 52,
	DEBUG_SERVER_TIME = 53,
	CARD_COMBINE_EXCEED = 54,
	SET_LOCK_SERVANT = 55,
	TUTORIAL_EVENT_FLAG_SET = 56,
	TAKEIN_STORAGE = 57,
	TAKEOUT_STORAGE = 58,
	FOLLOWER_EDIT_NAME = 59,
	BANK_STATUS = 60,
	CARD_COMBINE_COSTUME = 61,
	BLACKLIST_TOP = 62,
	BLACKLIST_REGIST = 63,
	BLACKLIST_REMOVE = 64,
	FRIEND_MESSAGE_HIDE_SYNC = 65,
	EVENT_SCRIPT_FLAG = 66,
	CARD_SVT_FLAG = 67,
	EVENT_LOCATION = 68,
	SET_STATUS_SERVANT = 69,
	SET_STATUS_COMMAND_CODE = 70,
	STATUS_SYNC_COMMAND_CODE = 71,
	SERVANT_RECOVERY_SYNC = 72,
	EVENT_DECK_SETUP = 73,
	USER_STATUS_FLAG_SET = 74,
	FRIEND_TOP = 75,
	COMMAND_CODE_ATTACH = 76,
	COMMAND_CODE_DETACH = 77,
	COMMAND_CODE_UNLOCK = 78,
	DEBUG_UPDATE_USER = 79,
	FOLLOW_ASSIGN = 80,
	FOLLOW_REMOVE = 81,
	EVENT_DAILY_POINT = 82,
	COMMAND_CARD_EXCEED = 83,
	CARD_COMBINE_LIMIT_SPECIAL = 84,
	BATTLE_QUEST_ROUTE = 85,
	FRIEND_LOCK_SYNC = 86,
	RAID_AUTO_UPDATE = 87,
	COMMAND_CODE_LOCK = 88,
	WARBOARD_START = 89,
	WARBOARD_SETUP = 90,
	WARBOARD_BUFF_SAVE = 91,
	WARBOARD_MOVE = 92,
	WARBOARD_TREASURE = 93,
	WARBOARD_TURN_END = 94,
	WARBOARD_MASTER_ATTACK = 95,
	WARBOARD_COMMAND_SPELL = 96,
	WARBOARD_BATTLE_RESULT = 97,
	WARBOARD_FINISH = 98,
	WARBOARD_RESUME = 99,
	EVENT_SCAN_PANEL_MAP = 100,
	BATTLE_USE_CONTINUE_ITEM = 101,
	CHECK_DATE_VERSION = 102,
	BATTLE_USE_ITEM = 103,
	COMBINE_APPEND_PASSIVE_SKILL = 104,
	TREASURE_BOX_DRAW = 105,
	EVENT_MISSION_RANDOM_CANCEL = 106,
	COIN_ROOM = 107,
	USER_DELETE = 108,
	BATTLE_RESET = 109,
	EVENT_DIGGING = 110,
	EVENT_RESET_DIGGING = 111,
	EVENT_EXPEDITION_START = 112,
	EVENT_EXPEDITION_FINISH = 113,
	CLIENT_API_ERROR_DIALOG = 114,
	EVENT_RECEIVE_COOLTIME_REWARD = 115,
	EVENT_CREATE_RECIPE = 116,
	EVENT_FORTIFICATION = 117,
	CLASS_BOARD_RELEASE_SQUARE = 118,
	CLASS_BOARD_RELEASE_LOCK = 119,
	EVENT_RESET_DATA_LOST_BATTLE = 120,
}
...
public enum QuestMessageMaster.FrequencyType
{
	NONE = 0,
	ONCE = 1,
}
