...
public enum DataNameKind.Kind
{
	...
	WAR_BOARD_STAGE_WALL = 326,
	WARBOARD_AI = 327,
	WARBOARD_RATING_BASE = 328,
	WARBOARD_RATING_OFFSET = 329,
	WARBOARD_ITEM = 330,
	WARBOARD_TREASURE = 331,
	WARBOARD_QUEST = 332,
	WARBOARD_DATA = 333,
	WARBOARD_INDIVIDUALITY_CLASS = 334,
	WARBOARD_ACTION_TREND_COND = 335,
	WARBOARD_ACTION_POINT_CLASS = 336,
	WAR_BOARD_REINFORCEMENTS = 337,
	WAR_BOARD_STAGE_REINFORCEMENTS = 338,
	EVENT_PANEL_MAP = 339,
	EVENT_PANEL_MAP_DETAIL = 340,
	EVENT_PANEL_SPOT = 341,
	EVENT_PANEL_SCAN = 342,
	EVENT_DIGGING = 343,
	EVENT_DIGGING_REWARD = 344,
	EVENT_DIGGING_BLOCK = 345,
	USER_EVENT_DIGGING = 346,
	COMMON_CONSUME = 347,
	USER_EVENT_MAP = 348,
	USER_EVENT_SPOT = 349,
	WAR_GROUP = 350,
	SERVANT_LIMIT_IMAGE = 351,
	FRIENDSHIP_QUEST_DIALOG_INFO = 352,
	QUEST_RESTRICTION_INFO = 353,
	ASSIST = 354,
	WARBOARD_EFFECT = 355,
	WARBOARD_ONBOARD_SKILL = 356,
	BEFORE_BIRTH_DAY = 357,
	LOGIN_QUEST = 358,
	EVENT_COMBINE_COSTUME = 359,
	WARBOARD_STAGE_PIECE_DETAIL = 360,
	SERVANT_TREASURE_DEVICE_ADD = 361,
	SKILL_ADD = 362,
	SERVANT_LEVEL_DETAIL = 363,
	GACHA_APPEND = 364,
	USER_GACHA_DRAW_LOG = 365,
	SERVANT_APPEND_PASSIVE_SKILL = 366,
	USER_SERVANT_APPEND_PASSIVE_SKILL = 367,
	USER_SERVANT_APPEND_PASSIVE_SKILL_LV = 368,
	SVT_APPEND_PASSIVE_SKILL_UNLOCK = 369,
	COMBINE_APPEND_PASSIVE_SKILL = 370,
	SVT_COIN = 371,
	USER_SVT_COIN = 372,
	SERVANT_ADD = 373,
	TREASURE_BOX = 374,
	TREASURE_BOX_GIFT = 375,
	TREASURE_BOX_TALK = 376,
	USER_EVENT_EXPEDITION = 377,
	EVENT_EXPEDITION = 378,
	EVENT_EXPEDITION_PIECE = 379,
	EVENT_RECIPE = 380,
	EVENT_RECIPE_GIFT = 381,
	USER_EVENT_FORTIFICATION = 382,
	EVENT_FORTIFICATION = 383,
	EVENT_FORTIFICATION_DETAIL = 384,
	EVENT_FORTIFICATION_SVT = 385,
	USER_SERVANT_VOICE_PLAYED = 386,
	UPDATE_PROFILE_DIALOG_INFO = 387,
	SVT_MATERIAL_TD = 388,
	BATTLE_MASTER_IMAGE = 389,
	USER_FRIEND_POINT_GACHA_FREE_DRAW_CAMPAIGN_LOG = 390,
	USER_EVENT_RANDOM_MISSION = 391,
	EVENT_PROGRESS_VALUE = 392,
	SVT_MULTI_PORTRAIT = 393,
	EVENT_RANDOM_MISSION = 394,
	USER_GACHA_HISTORY = 395,
	USER_COIN_ROOM = 396,
	EVENT_BUDDY_POINT = 397,
	EVENT_SERVANT_POINT_RANK = 398,
	USER_EVENT_SERVANT_POINT = 399,
	FIELD_MOTION = 400,
	USER_DELETE_RESERVATION = 401,
	SERVANT_SCRIPT_MULTIPLE = 402,
	EQUIP_ADD = 403,
	QUEST_RELEASE_OVERWRITE = 404,
	USER_EVENT_ALLOUT_BATTLE = 405,
	QUEST_SCRIPT_MATERIAL_NEXT = 406,
	BATTLE_MESSAGE = 407,
	BATTLE_MESSAGE_GROUP = 408,
	USER_NPC_SVT_RECORD = 409,
	BUFF_TYPE_DETAIL = 410,
	WARBOARD_MESSAGE = 411,
	WARBOARD_PARTY_SKILL = 412,
	WARBOARD_MESSAGE_SCRIPT = 413,
	WAR_QUEST_SELECTION = 414,
	WARBOARD_STAGE_DETAIL = 415,
	QUEST_SCRIPT_MATERIAL_OVERWRITE = 416,
	QUEST_SCRIPT_BRANCH_MATERIAL = 417,
	AD_CHECK_POINT = 418,
	GIFT_DETAIL = 419,
	COMBINE_LIMIT_GIFT = 420,
	EVENT_COOLTIME_REWARD = 421,
	USER_EVENT_COOLTIME_REWARD = 422,
	CLASS_BOARD_CLASS = 423,
	CLASS_BOARD_BASE = 424,
	CLASS_BOARD_LINE = 425,
	CLASS_BOARD_LOCK = 426,
	CLASS_BOARD_SQUARE = 427,
	CLASS_BOARD_COMMAND_SPELL = 428,
	USER_CLASS_BOARD_SQUARE = 429,
	SERVANT_CARD_ADD = 430,
	MAP_LAYER = 431,
	SPOT_LAYER = 432,
	MAP_GIMMICK_LAYER = 433,
	EVENT_DATA_LOST_BATTLE = 434,
	EVENT_DATA_LOST_BATTLE_RESET = 435,
	USER_EVENT_DATA_LOST = 436,
	QUEST_HINT = 437,
	FUNC_TYPE_DETAIL = 438,
	BUFF_CONVERT = 439,
	SKILL_GROUP = 440,
	SKILL_GROUP_OVERWRITE = 441,
	SKILL_INDIVIDUALITY = 442,
	RESTRICTION_BASE = 443,
	RESTRICTION_SLOT = 444,
	RESTRICTION_SLOT_DETAIL = 445,
	RESTRICTION_MESSAGE = 446,
	RESTRICTION_WHOLE = 447,
	FUNC_DISP = 448,
	EVENT_COMMAND_ASSIST = 449,
	EVENT_MISSION_GROUP = 450,
	COMBINE_LIMIT_RELEASE = 451,
	TREASURE_DEVICE_SEQUENCE_WEIGHT = 452,
	HEEL_PORTRAIT = 453,
	USER_HEEL_PORTRAIT = 454,
	NPC_SERVANT_FOLLOWER_INDIVIDUALITY = 455,
	GACHA_EXTRA_GIFT = 456,
	EVENT_MURAL = 457,
	VIEW_WAVE_ENEMY = 458,
	BLANK_EARTH_SPOT_NAVIMENU = 459,
	TERMINAL_OVERWRITE = 460,
	USER_EXCHANGE_SVT = 461,
	WAR_BOARD_COMMON_RELEASE = 462,
	WAR_BOARD_EVENT = 463,
	WAR_BOARD_EVENT_SCRIPT = 464,
	WAR_BOARD_STAGE_BOSS = 465,
	WAR_BOARD_SQUARE_INDEX_GROUP = 466,
...
public enum ResponseCommandKind.Kind
{
	...
	WARBOARD_WALL_ATTACK = 96,
	WARBOARD_COMMAND_SPELL = 97,
	WARBOARD_BATTLE_RESULT = 98,
	WARBOARD_FINISH = 99,
	WARBOARD_RESUME = 100,
	WARBOARD_CONTINUE = 101,
	WARBOARD_REINFORCEMENTS = 102,
	EVENT_SCAN_PANEL_MAP = 103,
	BATTLE_USE_CONTINUE_ITEM = 104,
	CHECK_DATE_VERSION = 105,
	BATTLE_USE_ITEM = 106,
	COMBINE_APPEND_PASSIVE_SKILL = 107,
	TREASURE_BOX_DRAW = 108,
	EVENT_MISSION_RANDOM_CANCEL = 109,
	COIN_ROOM = 110,
	USER_DELETE = 111,
	BATTLE_RESET = 112,
	EVENT_DIGGING = 113,
	EVENT_RESET_DIGGING = 114,
	EVENT_EXPEDITION_START = 115,
	EVENT_EXPEDITION_FINISH = 116,
	CLIENT_API_ERROR_DIALOG = 117,
	EVENT_RECEIVE_COOLTIME_REWARD = 118,
	EVENT_CREATE_RECIPE = 119,
	EVENT_FORTIFICATION = 120,
	CLASS_BOARD_RELEASE_SQUARE = 121,
	CLASS_BOARD_RELEASE_LOCK = 122,
	EVENT_RESET_DATA_LOST_BATTLE = 123,
}
