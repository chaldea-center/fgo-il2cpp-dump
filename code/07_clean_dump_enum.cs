...
public enum DataNameKind.Kind
{
	...
	MYROOM_ADD = 190,
	SHOP_ACTION = 191,
	EVENT_REWARD_SCENE_RELEASE = 192,
	MAP = 193,
	MAP_COND = 194,
	MAP_BUTTON = 195,
	BANNER_ADD = 196,
	...
	COMBINE_COSTUME = 201,
	SERVANT_COSTUME = 202,
	SERVANT_COSTUME_RELEASE = 203,
	USER_FRIEND_REQUEST_HISTORY = 204,
	USER_BLACKLIST = 205,
	ITEM_SELECT = 206,
	EVENT_RACE = 207,
	EVENT_RACE_RESULT = 208,
	QUEST_RACE_POINT = 209,
	USER_EVENT_RACE = 210,
	EVENT_SCRIPT = 211,
	EVENT_SCRIPT_RELEASE = 212,
	SPOT_PATH = 213,
	SPOT_ADD = 214,
	TOTAL_EVENT_RACE = 215,
	EVENT_POINT_GROUP_ADD = 216,
	VOICE_PLAY_GROUP = 217,
	VOICE_PLAY_COND = 218,
	GACHA_STORY_ADJUST = 219,
	SERVANT_FLAG = 220,
	SERVANT_FLAG_RELEASE = 221,
	EVENT_LOCATION_CAMPAIGN = 222,
	CAMPAIGN_INFO = 223,
	DIALOG_MESSAGE = 224,
	SERVANT_INDIVIDUALITY = 225,
	BOARD_MESSAGE = 226,
	BOARD_MESSAGE_RELEASE = 227,
	EVENT_SERVANT_FATIGUE = 228,
	USER_EVENT_DECK = 229,
	EVENT_TOWER = 230,
	EVENT_TOWER_REWARD = 231,
	EVENT_BULLETIN_BOARD = 232,
	EVENT_BULLETIN_BOARD_RELEASE = 233,
	EVENT_FACTORY = 234,
	SHOP_GROUP = 235,
	AURA_EFFECT = 236,
	AURA_EFFECT_POS_OVERWRITE = 237,
	USER_EVENT_MISSION_FIX = 238,
	NOT_END_EVENT_MISSION_FIX = 239,
	ENEMY_MASTER = 240,
	ENEMY_MASTER_BATTLE = 241,
	SERVANT_SKILL_RELEASE = 242,
	SERVANT_PASSIVE_SKILL_RELEASE = 243,
	SERVANT_TREASUREDEVICE_RELEASE = 244,
	MAP_GIMMICK_RELEASE = 245,
	COMMAND_CODE = 246,
	SERVANT_COMMAND_CODE_UNLOCK = 247,
	USER_COMMAND_CODE = 248,
	USER_COMMAND_CODE_COLLECTION = 249,
	USER_SERVANT_COMMAND_CODE = 250,
	COMMAND_CODE_SKILL = 251,
	COMMAND_CODE_SKILL_RELEASE = 252,
	COMMAND_CODE_COMMENT = 253,
	EVENT_STATUS = 254,
	EVENT_STATUS_QUEST = 255,
	COMMON_RESTRICTION = 256,
	EVENT_POINT_BUFF = 257,
	USER_FOLLOW = 258,
	EVENT_REWARD_GUIDE_RELEASE = 259,
	NPC_SERVANT_EQUIP = 260,
	EVENT_CAMPAIGN_RELEASE = 261,
	SERVANT_MATERIAL_FOLDER = 262,
	EVENT_EQUIP_SKILL_RELEASE = 263,
	EVENT_POINT_ACTIVITY = 264,
	FUNCTION_CATEGORY = 265,
	QUEST_PICKUP = 266,
	EVENT_UI = 267,
	EVENT_UI_RELEASE = 268,
	EVENT_UI_VALUE = 269,
	EVENT_CONQUEST_REWARD = 270,
	NPC_FOLLOWER_RELEASE = 271,
	EVENT_BONUS_FILTER = 272,
	EVENT_BONUS_FILTER_GROUP_INFO = 273,
	EVENT_BONUS_FILTER_GROUP_MEMBER = 274,
	USER_GACHA_EXTRA_COUNT = 275,
	COMMAND_CARD_RANK_PARAM = 276,
	USER_SERVANT_COMMAND_CARD = 277,
	PRIVILEGE = 278,
	USER_PRIVILEGE = 279,
	QUEST_DATE_RANGE = 280,
	EVENT_POINT_UPPER = 281,
	EVENT_POINT_UPPER_RELEASE = 282,
	USER_QUEST_ROUTE = 283,
	EVENT_BOSS_STATUS_UI = 284,
	COMMON_RELEASE = 285,
	QUEST_SPOT_RELEASE = 286,
	VOICE_MATERIAL_COND = 287,
	CLASS_RELATION_OVERWRITE = 288,
	EVENT_GROUP = 289,
	ASSETBUNDLE_KEY = 290,
	TOTAL_BOX_GACHA = 291,
	SERVANT_TREASURE_DEVICE_DAMAGE = 292,
	USER_EVENT_SERVANT_FATIGUE = 293,
	EVENT_REWARD_BG = 294,
	EVENT_FATIGUE_RECOVERY = 295,
	EVENT_BOOST_ITEM_USED = 296,
	STATUS_EFFECT_POS_OVERWRITE = 297,
	QUEST_PHASE_DETAIL_ADD = 298,
	VOICE_CLOSED_MESSAGE = 299,
	STAGE_REMAP = 300,
	USER_COMBINE_EXP = 301,
	EVENT_BOARD_GAME_CELL = 302,
	EVENT_BOARD_GAME_TOKEN = 303,
	EVENT_BOARD_GAME_TOKEN_REWARD = 304,
	USER_EVENT_BOARD_GAME_TOKEN = 305,
	SERVANT_ANIMATION_OVERWRITE = 306,
	OPENING_MOVIE = 307,
	SERVANT_LIMIT_SPOILER_PROTECTION = 308,
	PICKUP_USER_FOLLOWER = 309,
	SERVANT_COLLECTION = 310,
	GACHA_BEHAVIOR = 311,
	EVENT_QUEST_COOLTIME = 312,
	USER_EVENT_QUEST_COOLTIME = 313,
	BOOST = 314,
	WARBOARD = 315,
	WARBOARD_SQUARE = 316,
	WARBOARD_ROAD = 317,
	WARBOARD_STAGE = 318,
	WARBOARD_ACTION_POINT = 319,
	WARBOARD_ACTION_TREND = 320,
	WARBOARD_TACTICAL_TREND = 321,
	WARBOARD_STAGE_LAYOUT = 322,
	WARBOARD_STAGE_NPC = 323,
	WARBOARD_AI = 324,
	WARBOARD_RATING_BASE = 325,
	WARBOARD_RATING_OFFSET = 326,
	WARBOARD_ITEM = 327,
	WARBOARD_TREASURE = 328,
	WARBOARD_QUEST = 329,
	WARBOARD_DATA = 330,
	WARBOARD_INDIVIDUALITY_CLASS = 331,
	WARBOARD_ACTION_TREND_COND = 332,
	WARBOARD_ACTION_POINT_CLASS = 333,
	EVENT_PANEL_MAP = 334,
	EVENT_PANEL_MAP_DETAIL = 335,
	EVENT_PANEL_SPOT = 336,
	EVENT_PANEL_SCAN = 337,
	EVENT_DIGGING = 338,
	EVENT_DIGGING_REWARD = 339,
	EVENT_DIGGING_BLOCK = 340,
	USER_EVENT_DIGGING = 341,
	COMMON_CONSUME = 342,
	USER_EVENT_MAP = 343,
	USER_EVENT_SPOT = 344,
	WAR_GROUP = 345,
	SERVANT_LIMIT_IMAGE = 346,
	FRIENDSHIP_QUEST_DIALOG_INFO = 347,
	QUEST_RESTRICTION_INFO = 348,
	ASSIST = 349,
	WARBOARD_EFFECT = 350,
	WARBOARD_ONBOARD_SKILL = 351,
	BEFORE_BIRTH_DAY = 352,
	LOGIN_QUEST = 353,
	EVENT_COMBINE_COSTUME = 354,
	WARBOARD_STAGE_PIECE_DETAIL = 355,
	SERVANT_TREASURE_DEVICE_ADD = 356,
	SKILL_ADD = 357,
	SERVANT_LEVEL_DETAIL = 358,
	GACHA_APPEND = 359,
	USER_GACHA_DRAW_LOG = 360,
	SERVANT_APPEND_PASSIVE_SKILL = 361,
	USER_SERVANT_APPEND_PASSIVE_SKILL = 362,
	USER_SERVANT_APPEND_PASSIVE_SKILL_LV = 363,
	SVT_APPEND_PASSIVE_SKILL_UNLOCK = 364,
	COMBINE_APPEND_PASSIVE_SKILL = 365,
	SVT_COIN = 366,
	USER_SVT_COIN = 367,
	SERVANT_ADD = 368,
	TREASURE_BOX = 369,
	TREASURE_BOX_GIFT = 370,
	TREASURE_BOX_TALK = 371,
	USER_EVENT_EXPEDITION = 372,
	EVENT_EXPEDITION = 373,
	EVENT_EXPEDITION_PIECE = 374,
	EVENT_RECIPE = 375,
	EVENT_RECIPE_GIFT = 376,
	USER_EVENT_FORTIFICATION = 377,
	EVENT_FORTIFICATION = 378,
	EVENT_FORTIFICATION_DETAIL = 379,
	EVENT_FORTIFICATION_SVT = 380,
	USER_SERVANT_VOICE_PLAYED = 381,
	UPDATE_PROFILE_DIALOG_INFO = 382,
	SVT_MATERIAL_TD = 383,
	BATTLE_MASTER_IMAGE = 384,
	USER_FRIEND_POINT_GACHA_FREE_DRAW_CAMPAIGN_LOG = 385,
	USER_EVENT_RANDOM_MISSION = 386,
	EVENT_PROGRESS_VALUE = 387,
	SVT_MULTI_PORTRAIT = 388,
	EVENT_RANDOM_MISSION = 389,
	USER_GACHA_HISTORY = 390,
	USER_COIN_ROOM = 391,
	EVENT_BUDDY_POINT = 392,
	EVENT_SERVANT_POINT_RANK = 393,
	USER_EVENT_SERVANT_POINT = 394,
	FIELD_MOTION = 395,
	USER_DELETE_RESERVATION = 396,
	SERVANT_SCRIPT_MULTIPLE = 397,
	EQUIP_ADD = 398,
	QUEST_RELEASE_OVERWRITE = 399,
	USER_EVENT_ALLOUT_BATTLE = 400,
	QUEST_SCRIPT_MATERIAL_NEXT = 401,
	BATTLE_MESSAGE = 402,
	BATTLE_MESSAGE_GROUP = 403,
	USER_NPC_SVT_RECORD = 404,
	BUFF_TYPE_DETAIL = 405,
	WARBOARD_MESSAGE = 406,
	WARBOARD_PARTY_SKILL = 407,
	WARBOARD_MESSAGE_SCRIPT = 408,
	WAR_QUEST_SELECTION = 409,
	WARBOARD_STAGE_DETAIL = 410,
	QUEST_SCRIPT_MATERIAL_OVERWRITE = 411,
	QUEST_SCRIPT_BRANCH_MATERIAL = 412,
	AD_CHECK_POINT = 413,
	GIFT_DETAIL = 414,
	COMBINE_LIMIT_GIFT = 415,
	EVENT_COOLTIME_REWARD = 416,
	USER_EVENT_COOLTIME_REWARD = 417,
	CLASS_BOARD_CLASS = 418,
	CLASS_BOARD_BASE = 419,
	CLASS_BOARD_LINE = 420,
	CLASS_BOARD_LOCK = 421,
	CLASS_BOARD_SQUARE = 422,
	CLASS_BOARD_COMMAND_SPELL = 423,
	USER_CLASS_BOARD_SQUARE = 424,
	SERVANT_CARD_ADD = 425,
	MAP_LAYER = 426,
	SPOT_LAYER = 427,
	MAP_GIMMICK_LAYER = 428,
	EVENT_DATA_LOST_BATTLE = 429,
	EVENT_DATA_LOST_BATTLE_RESET = 430,
	USER_EVENT_DATA_LOST = 431,
	QUEST_HINT = 432,
	FUNC_TYPE_DETAIL = 433,
	BUFF_CONVERT = 434,
	SKILL_GROUP = 435,
	SKILL_GROUP_OVERWRITE = 436,
	SKILL_INDIVIDUALITY = 437,
	RESTRICTION_BASE = 438,
	RESTRICTION_SLOT = 439,
	RESTRICTION_SLOT_DETAIL = 440,
	RESTRICTION_MESSAGE = 441,
	RESTRICTION_WHOLE = 442,
	FUNC_DISP = 443,
...
public enum SummonInfoControl.SummonState
{
	FREE_SUMMON = 0,
	SINGLE_POINT_SUMMON = 1,
	MULTI_POINT_SUMMON = 2,
	SINGLE_PAY_SUMMON = 3,
	MULTI_PAY_SUMMON = 4,
	TICKET_SUMMON = 5,
}
